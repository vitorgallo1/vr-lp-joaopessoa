...
const DESCRICAO = `Concessionária ${UNIDADE.nome} com showroom completo, oficina especializada e condições que cabem no seu bolso. Sinta a experiência VR.`;
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: UNIDADE.nome },
